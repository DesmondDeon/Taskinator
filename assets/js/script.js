...
var tasksInProgressEL = document.querySelector("task-in-progresso");
var tasksCompletedEl = docuement.querySelector("#tasks-Completed");
...
// check if inputs empty (validate)
...
if (isEdit) {
    ...
    createdTaskEL(taskDataObj);
  }
};

var createTaskEl = function(taskDataObj) {
    var listItemEL = docuement.createElement("li");
